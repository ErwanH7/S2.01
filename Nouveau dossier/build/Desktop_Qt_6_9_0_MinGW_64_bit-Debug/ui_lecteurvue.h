...
public:
    ...
    QSlider *tempEcoule;
    QLabel *labelTempDebut;
    QLabel *labelTempsFin;
    ...
    void setupUi(QMainWindow *LecteurVue)
    {
        ...
        labelTempDebut = new QLabel(groupBox_5);
        labelTempDebut->setObjectName("labelTempDebut");

        horizontalLayout->addWidget(labelTempDebut);

        labelTempsFin = new QLabel(groupBox_5);
        labelTempsFin->setObjectName("labelTempsFin");

        horizontalLayout->addWidget(labelTempsFin);
    ...
    void retranslateUi(QMainWindow *LecteurVue)
    {
        ...
        labelTempDebut->setText(QCoreApplication::translate("LecteurVue", "00.00 ", nullptr));
        labelTempsFin->setText(QCoreApplication::translate("LecteurVue", "/ 00.00", nullptr));
